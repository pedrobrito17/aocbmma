...
public class SecurityWebConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .antMatchers("/associese").permitAll()
                .antMatchers("/cadastrar-novo-socio").permitAll()
                .antMatchers("/esqueceu-senha").permitAll()
                .antMatchers("/recuperar-senha").permitAll()
                .antMatchers("/nova-senha/**").permitAll()
                .antMatchers("/alterar-senha").permitAll()
                .antMatchers("/alterar-senha/**").permitAll()
                .antMatchers("/admin/**").hasAuthority("ADMIN")
                .antMatchers("/sisaocbmma/**").hasAuthority("SOCIO")
                .antMatchers("/**").hasAuthority("SOCIO")
