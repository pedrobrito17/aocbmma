...
CREATE TABLE `pagamento_mensalidade` (
  ...
  `socio_cod` int(11) NOT NULL,
  PRIMARY KEY (`cod`),
  KEY `FKa8pblq64phmgvx4nm3swqlli` (`socio_cod`)
...
INSERT INTO `pagamento_mensalidade` VALUES (1,'2019-05-01','2019-05-31',1),(2,'2019-06-01','2019-05-31',1);
...
-- Dump completed on 2019-06-21 18:20:01
